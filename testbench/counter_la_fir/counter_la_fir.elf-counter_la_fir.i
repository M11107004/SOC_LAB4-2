# 0 "counter_la_fir.c"
# 1 "/home/ubuntu/Desktop/lab4/Lab4-2/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_fir.c"
# 19 "counter_la_fir.c"
...
# 147 "counter_la_fir.c"
 ...
 for (int j=0 ; j < 3; j++)
 {
  (*(volatile uint32_t *)(0x30000010)) = 11 ;
  (*(volatile uint32_t *)0x30000000)=0x01;
  for (int i = 0; i < 11; i++)
  {
   (*(volatile uint32_t *)0x30000080) = *(x + i);
  }

 }

 (*(volatile uint32_t*)0x2600000c) = 0x00A60000;
 if ((*(volatile uint32_t *)0x30000000) == 0x044A)
 {
  (*(volatile uint32_t*)0x2600000c) = 0x00A60000;
 }
