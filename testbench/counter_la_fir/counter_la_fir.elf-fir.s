...
.Ltext0:
	...
	.file 0 "/home/ubuntu/Desktop/lab4/Lab4-2/lab-caravel_fir/testbench/counter_la_fir" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L3:
	...
	add	a5,a4,a5
	sw	zero,0(a5)
	.loc 1 5 27 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L2:
	.loc 1 5 20 discriminator 1
	lw	a4,-20(s0)
	li	a5,10
	ble	a4,a5,.L3
.LBE2:
...
.L7:
	...
	lw	a5,-24(s0)
	sub	a5,a4,a5
	.loc 1 14 44 discriminator 3
	lui	a4,%hi(taps)
	addi	a4,a4,%lo(taps)
	slli	a5,a5,2
	add	a5,a4,a5
	lw	a5,0(a5)
	.loc 1 14 38 discriminator 3
	mv	a1,a5
	mv	a0,a3
	call	__mulsi3
	mv	a5,a0
